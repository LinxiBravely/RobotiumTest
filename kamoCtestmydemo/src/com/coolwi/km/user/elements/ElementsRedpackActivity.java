...
public class ElementsRedpackActivity {
	private Solo solo;
	...
	public ElementsRedpackActivity(Solo solo){
		this.solo=solo;
	}
	
	public  void initmyOperationFun() {
		if (myOperationFun==null) {
			try {
				myOperationFun=new myOperationFun();
			} catch (Exception e) {
